package com.osama.recyclerviewinsetanddeleteandclick;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void insertItem(int position){
        mExampleList.add(position,new ExampleItem(R.drawable.ic_sun,
                "item inserted line one","item inserted line two"));
